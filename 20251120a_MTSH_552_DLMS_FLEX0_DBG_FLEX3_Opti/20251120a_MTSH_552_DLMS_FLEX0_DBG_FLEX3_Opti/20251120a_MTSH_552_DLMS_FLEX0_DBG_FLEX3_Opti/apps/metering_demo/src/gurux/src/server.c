...
#define GURUX_SERVER_USART_Write    FLEXCOM3_USART_Write
...
int svr_initialize(
    dlmsServerSettings* settings)
{
    // NImish removed because of errors GURUX_SERVER_USART_Write("svr_initialize\r\n", sizeof ("svr_initialize\r\n"));
...
void svr_setInitialize(dlmsServerSettings* settings)
{
    ...
    // Nimish removed because of errors GURUX_SERVER_USART_Write("svr_setInitialize\r\n", sizeof ("svr_setInitialize\r\n"));
    ...
    dlmsServerSettings* settings)
{
    ...
    GURUX_SERVER_USART_Write("svr_reset\r\n", sizeof ("svr_reset\r\n"));
    ...
    gxByteBuffer* data)
{
    ...
    GURUX_SERVER_USART_Write("svr_generateExceptionResponse\r\n", sizeof ("svr_generateExceptionResponse\r\n")); 
...
int svr_HandleAarqRequest(
    ...
    gxByteBuffer* data)
{
    GURUX_SERVER_USART_Write("svr_HandleAarqRequest\r\n", sizeof ("svr_HandleAarqRequest\r\n")); 
    ...
    gxByteBuffer* data)
{
    ...
    GURUX_SERVER_USART_Write("svr_handleSnrmRequest\r\n", sizeof ("svr_handleSnrmRequest\r\n"));
...
int svr_generateDisconnectRequest(
    ...
    gxByteBuffer* data)
{
    GURUX_SERVER_USART_Write("svr_generateDisconnectRequest\r\n", sizeof ("svr_generateDisconnectRequest\r\n")); 
...
int dlms_addFrame(
    ...
    gxByteBuffer* reply)
{
    GURUX_SERVER_USART_Write("dlms_addFrame\r\n", sizeof ("dlms_addFrame\r\n")); 
    ...
    {
        GURUX_SERVER_USART_Write("dlms_addFrame,DLMS_INTERFACE_TYPE_HDLC\r\n", sizeof ("dlms_addFrame,DLMS_INTERFACE_TYPE_HDLC\r\n")); 
    ...
    case DLMS_INTERFACE_TYPE_WRAPPER:
        ...
        GURUX_SERVER_USART_Write("dlms_addFrame,DLMS_INTERFACE_TYPE_WRAPPER\r\n", sizeof ("dlms_addFrame,DLMS_INTERFACE_TYPE_WRAPPER\r\n")); 
    ...
    case DLMS_INTERFACE_TYPE_PDU:
        GURUX_SERVER_USART_Write("dlms_addFrame,DLMS_INTERFACE_TYPE_PDU\r\n", sizeof ("dlms_addFrame,DLMS_INTERFACE_TYPE_PDU\r\n")); 
...
int svr_reportError(
    ...
    gxByteBuffer* reply)
{
    GURUX_SERVER_USART_Write("svr_reportError\r\n", sizeof ("svr_reportError\r\n"));
    ...
    GURUX_SERVER_USART_Write("svr_reportError->dlms_addFrame\r\n", sizeof ("svr_reportError->dlms_addFrame\r\n"));
...
int svr_handleSetRequest2(
    ...
    gxLNParameters* p)
{
    GURUX_SERVER_USART_Write("svr_handleSetRequest2\r\n", sizeof ("svr_handleSetRequest2\r\n"));
    ...
    gxByteBuffer* data)
{
    ...
    GURUX_SERVER_USART_Write("svr_generateConfirmedServiceError\r\n", sizeof ("svr_generateConfirmedServiceError\r\n")); 
    ...
    gxByteBuffer* data)
{
    ...
    GURUX_SERVER_USART_Write("svr_handleSetRequest\r\n", sizeof ("svr_handleSetRequest\r\n"));
...
{
    GURUX_SERVER_USART_Write("svr_getRequestNormal\r\n", sizeof ("svr_getRequestNormal\r\n")); 
    ...
    unsigned char invokeId)
{
    ...
    GURUX_SERVER_USART_Write("svr_getRequestNextDataBlock\r\n", sizeof ("svr_getRequestNextDataBlock\r\n")); 
...
int svr_getRequestWithList(
    ...
    unsigned char invokeId)
{
    GURUX_SERVER_USART_Write("svr_getRequestWithList\r\n", sizeof ("svr_getRequestWithList\r\n")); 
    ...
    gxByteBuffer* data)
{
    ...
    GURUX_SERVER_USART_Write("svr_handleGetRequest\r\n", sizeof ("svr_handleGetRequest\r\n"));
    int ret;
    ...
    unsigned char* multipleBlocks)
{
    ...
    GURUX_SERVER_USART_Write("svr_getReadData\r\n", sizeof ("svr_getReadData\r\n")); 
...
int svr_handleMethodRequest(
    ...
    gxByteBuffer* data)
{
    GURUX_SERVER_USART_Write("svr_handleMethodRequest\r\n", sizeof ("svr_handleMethodRequest\r\n"));
    ...
    else
    {
        ...
        else
        {
            ...
            if (!e->handled)
            {
                ...
                GURUX_SERVER_USART_Write("bef svr_postAction\r\n", sizeof ("bef svr_postAction\r\n"));
...
int svr_handleReleaseRequest(
    ...
    GURUX_SERVER_USART_Write("svr_handleReleaseRequest\r\n", sizeof ("svr_handleReleaseRequest\r\n"));
    ...
    gxByteBuffer* data)
{
    ...
    GURUX_SERVER_USART_Write("svr_registerRequest\r\n", sizeof ("svr_registerRequest\r\n"));
    gxByteBuffer bb;
    BYTE_BUFFER_INIT(&bb);
...
int svr_parseRegisterRequest(
    ...
    gxByteBuffer* value)
{
    GURUX_SERVER_USART_Write("svr_parseRegisterRequest\r\n", sizeof ("svr_parseRegisterRequest\r\n"));
...
int svr_parseDiscoverRequest(
    ...
    gxPlcRegister* reg)
{
    GURUX_SERVER_USART_Write("svr_parseDiscoverRequest\r\n", sizeof ("svr_parseDiscoverRequest\r\n"));
...
int dlms_pingRequest(
    ...
    gxByteBuffer* data)
{
    GURUX_SERVER_USART_Write("dlms_pingRequeste\r\n", sizeof ("dlms_pingRequest\r\n")); 
...
{
    GURUX_SERVER_USART_Write("dlm_parsePing\r\n", sizeof ("dlm_parsePing\r\n")); 
    ...
    gxByteBuffer* data)
{
    ...
    GURUX_SERVER_USART_Write("dlms_repeaterCallRequest\r\n", sizeof ("dlms_repeaterCallRequest\r\n")); 
...
int svr_discoverReport(
    ...
    gxByteBuffer* data)
{
    GURUX_SERVER_USART_Write("svr_discoverReport\r\n", sizeof ("svr_discoverReport\r\n")); 
...
int svr_handleCommand(
    ...
    gxByteBuffer* reply)
{
    GURUX_SERVER_USART_Write("svr_handleCommand\r\n", sizeof ("svr_handleCommand\r\n"));
    ...
    case DLMS_COMMAND_METHOD_REQUEST:
        ...
        {
            GURUX_SERVER_USART_Write("svr_handleCommand->svr_handleMethodRequest\r\n", sizeof ("svr_handleCommand->svr_handleMethodRequest\r\n"));
    ...
    GURUX_SERVER_USART_Write("svr_handleCommand->dlms_addFrame\r\n", sizeof ("svr_handleCommand->dlms_addFrame\r\n"));
...
int svr_handleRequest(
    ...
    gxByteBuffer* reply)
{
    GURUX_SERVER_USART_Write("svr_handleRequest\r\n", sizeof ("svr_handleRequest\r\n"));
...
int svr_handleRequest3(
    ...
    gxByteBuffer* reply)
{
    GURUX_SERVER_USART_Write("svr_handleRequest3\r\n", sizeof ("svr_handleRequest3\r\n"));
...
int svr_handleRequest2(
    ...
    gxByteBuffer* reply)
{
    //GURUX_SERVER_USART_Write("svr_h2\r\n", sizeof ("svr_h2\r\n"));
    gxServerReply sr;
    sr.data = buff;
    sr.dataSize = size;
    sr.reply = reply;
    ...
    gxServerReply* sr)
{
    ...
    if ((ret = dlms_getData2(&settings->base, &settings->receivedData, &settings->info, first)) != 0)
    {
            ...
            ret == DLMS_ERROR_CODE_INVALID_COMMAND)
        {
            ...
            GURUX_SERVER_USART_Write("svr_handleRequest2->dlms_addFrame\r\n", sizeof ("svr_handleRequest2->dlms_addFrame\r\n"));
...
#endif //DLMS_IGNORE_WRAPPER
    GURUX_SERVER_USART_Write("\r\nsvr_handleRequest2->svr_handleCommand\r\n", sizeof ("\r\nsvr_handleRequest2->svr_handleCommand\r\n"));
...
int svr_handleInactivityTimeout(
    ...
    uint32_t* next)
{
    GURUX_SERVER_USART_Write("svr_handleInactivityTimeout\r\n", sizeof ("svr_handleInactivityTimeout\r\n"));
...
int svr_invoke(
    ...
    uint32_t* next)
{
    GURUX_SERVER_USART_Write("svr_invoke\r\n", sizeof ("svr_invoke\r\n"));
    ...
    if (exec)
    {
        *executed = time;
        ...
        {
        	GURUX_SERVER_USART_Write("bef svr_postAction 1\r\n", sizeof ("bef svr_postAction 1\r\n"));
    ...
    uint32_t* next)
{
    ...
    GURUX_SERVER_USART_Write("svr_handleProfileGeneric\r\n", sizeof ("svr_handleProfileGeneric\r\n"));
    ...
    uint32_t* next)
{
    ...
    GURUX_SERVER_USART_Write("svr_handleSingleActionSchedule\r\n", sizeof ("svr_handleSingleActionSchedule\r\n"));
    ...
    uint32_t* next)
{
    ...
    GURUX_SERVER_USART_Write("svr_run\r\n", sizeof ("svr_run\r\n"));
    uint16_t pos;
    int ret = 0;
    gxObject* obj;
    *next = (uint32_t)-1;
...
{
    //GURUX_SERVER_USART_Write("svr_isChangedWithAction\r\n", sizeof ("svr_isChangedWithAction\r\n"));
    
    unsigned char prt_buf[100];
    unsigned char prt_len;
    prt_len=sprintf(prt_buf, "svr_isChangedWithAction, objectType= %d, methodIndex= %d\r\n", objectType, methodIndex);
    GURUX_SERVER_USART_Write(prt_buf, prt_len); 
...
{
    GURUX_SERVER_USART_Write("svr_monitor\r\n", sizeof ("svr_monitor\r\n"));
    int ret;
    unsigned char pos;
    gxValueEventCollection args;
    gxValueEventArg* e;
...
{
    GURUX_SERVER_USART_Write("svr_monitorAll\r\n", sizeof ("svr_monitorAll\r\n"));
