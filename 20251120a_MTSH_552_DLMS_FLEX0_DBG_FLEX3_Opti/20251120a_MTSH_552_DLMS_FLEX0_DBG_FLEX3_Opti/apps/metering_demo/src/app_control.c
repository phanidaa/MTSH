...
#define APP_CONTROL_USART_WRITE  FLEXCOM3_USART_Write
#define APP_CONTROL_USART_TransmitComplete  FLEXCOM3_USART_TransmitComplete
            ...
            if (appInitialized)
            {
                ...
                switch (RSTC_ResetCauseGet()) {
                    case RSTC_SR_RSTTYP_GENERAL_RST:
                        ...
                        APP_CONTROL_USART_WRITE(app_controlData.prtbuf, app_controlData.prtlen);
                        while (!(APP_CONTROL_USART_TransmitComplete()));
                        break;
                ...
                APP_CONTROL_USART_WRITE(app_controlData.prtbuf,app_controlData.prtlen); while(!(APP_CONTROL_USART_TransmitComplete()));
