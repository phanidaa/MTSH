...
int apdu_parsePDU(
    ...
    unsigned char* command)
{
    // Nimish removed to solve error FLEXCOM3_USART_Write("apdu_parsePDU\r\n", sizeof ("apdu_parsePDU\r\n")); 
...
int apdu_generateAARE(
    ...
    unsigned char command)
{
    // NImish removed because of error FLEXCOM3_USART_Write("apdu_generateAARE\r\n", sizeof ("apdu_generateAARE\r\n")); 
